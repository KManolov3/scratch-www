...
const reportPath = join(__dirname, "reports", "html-reports");
...
export const config: WebdriverIO.Config = {
  ...
  beforeTest: async function (test: Test) {
  ...
  afterTest: async function (test: Test, context: any, result: TestResult) {
    let testTitle = test.title.toUpperCase();
    let color = result.passed ? green : red;
